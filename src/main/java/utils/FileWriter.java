...
public class FileWriter
{
  ...
  public void saveFile(String baseName, BufferedImage[] imgs, ImageReader inputReader)
  {
    try
    {
  ...
  public void saveMaskFile(String baseName, BufferedImage[] imgs, int intensityOfMask,
  ...
  public void saveAnalyzeFile(String baseName, BufferedImage[] imgs, ImageReader inputReader)
  {
    try
    {
      ...
      // Create the metadata
      AnalyzeMetadata metadata = (AnalyzeMetadata) inputReader.getStreamMetadata();
  ...
  public void saveMincFile(String fileName, BufferedImage[] imgs, ImageReader inputReader)
  {
    try
    {
  ...
  public void saveMincMaskFile(String fileName, BufferedImage[] imgs, int intensityOfMask,
      ImageReader inputReader)
  {
    try
    {
      ...
      _setMaxOrMinIntensityValues(node, imgs.length, "image-max", intensityOfMask);
  ...
  /**
   * Setss Maximum or Minimum pixel values, each corresponding to the maximum or minimum pixel value
   * of one slice.
   * 
   ...
   */
  private void _setMaxOrMinIntensityValues(Node node, int numOfImages, String nodeName,
      int intensity)
  {
    NamedNodeMap map;
    Node attribute;
